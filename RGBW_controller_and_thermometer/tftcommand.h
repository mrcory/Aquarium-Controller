...
void aniBitmap(int _x, int _y,unsigned long _frameDelay, uint16_t _color1, uint16_t _color2) { //Test for animated bitmap
  ...
  if (millis() - timer >= _frameDelay) {
    if (frame == 0) {Serial.print("[DEBUG] ");
      ...
      //display.drawBitmap(_x,_y,warnBitmap,9,9,ST7735_BLACK); //Clear old image
      display.drawBitmap(_x,_y,warnBitmap,9,9,_color1);
      timer = millis();
      frame = 1;
    } else {
    if (frame == 1) {Serial.print("[DEBUG1] ");
      //Serial.println(millis() - timer);
      //display.drawBitmap(_x,_y,warnBitmap,9,9,ST7735_BLACK); //Clear old image
      display.drawBitmap(_x,_y,clockBitmap,9,9,_color2); 
      timer = millis();
      frame = 0;
    }
    }
